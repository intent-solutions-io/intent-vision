...
import { ForecastPoint } from './forecast.js';
import { Anomaly, AnomalySeverity } from './anomaly.js';

// =============================================================================
// Alert Trigger - The Core Event
// =============================================================================
...
export type AlertStatus =
  ...
  | 'pending'     // Condition met, waiting for confirmation
  | 'resolved'    // Condition no longer met
  | 'acknowledged'// User acknowledged
  | 'suppressed'; // Suppressed by rule
...
export type AlertTriggerType =
  ...
  | 'forecast'         // Forecast predicts issue
  | 'rate_of_change'   // Metric changing too fast
  | 'missing_data'     // Expected data not received
  | 'composite';       // Multiple conditions

// =============================================================================
// Alert Context and Details
// =============================================================================
...
export interface AlertMetricContext {
  ...
  recent_values?: Array<{ timestamp: ISOTimestamp; value: number }>;
 ...
 */
export type AlertTriggerDetails =
...
export interface RateOfChangeTriggerDetails {
  ...
  rate_unit: string;      // e.g., "per_minute", "per_hour"
...
export type AlertCondition =
  | { type: 'threshold'; operator: string; value: number; duration_ms?: number }
